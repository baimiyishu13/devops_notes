...
![image-20240109231539414](./images/ansible/image-20240109231539414.png)
...
在删除文件`rm -rf /home/ansible/.ssh/known_hosts`
 ...
 ![image-20240110210608919](./images/ansible/image-20240110210608919.png)
...
```
 ...
 ![image-20240110210850867](./images/ansible/image-20240110210850867.png)
...
![image-20240110211616276](./images/ansible/image-20240110211616276.png)

选项：`--list-hosts` ![image-20240110211737464](./images/ansible/image-20240110211737464.png)
...
![image-20240110214146135](./images/ansible/image-20240110214146135.png)
...
```
 ...
 ![image-20240110215507024](./images/ansible/image-20240110215507024.png)
...
例如，`file` 模块和 `copy` 模块都是具有幂等性的模块。当你使用这些模块来创建目录、复制文件等操作时，Ansible 会检查系统的当前状态，只有当需要的变更尚未发生时才执行操作，否则将跳过任务。 ![image-20240111104123360](./images/ansible/image-20240111104123360.png)
...
```
 ...
 ![image-20240112212639216](./images/ansible/image-20240112212639216.png)
...
![image-20240112221218695](./images/ansible/image-20240112221218695.png)
...
```
 ...
 ![image-20240116122759223](./images/ansible/image-20240116122759223.png)
...
![image-20240116125011843](./images/ansible/image-20240116125011843.png)
...
```
 ...
 ![image-20240116223851739](./images/ansible/image-20240116223851739.png)
